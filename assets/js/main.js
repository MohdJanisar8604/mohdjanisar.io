...
<div class="nav-wrapper">
    ...
    <ul class="right hide-on-med-and-down">
        ...
        <li><a class="white-text" href="https://drive.google.com/file/d/1A3O7RTwiMpAV50zjQ2iochqFBCnx-dwe/view?usp=drivesdk" target="_blank">My Resume</a></li>
...
<div class="social-icons-footer mx-lg-auto">
  <a class="social-icon-footer twitter" href="https://twitter.com/mohdjanisar1" target="_blank" rel="author">
    <i class="fab fa-twitter"></i>
      </a>
  <a class="social-icon-footer dribbble" href="https://www.instagram.com/sufiyan.janisar/?hl=en" target="_blank" rel="author">
    <i class="fab fa-instagram"></i>
      </a>
  <a class="social-icon-footer linkedin" href="https://www.linkedin.com/in/mohd-janisar-705b921a8/" target="_blank" rel="author">
  ...
  <a class="social-icon-footer github" href="https://github.com/MohdJanisar8604" target="_blank" rel="author">
    <i class="fab fa-github"></i>
      </a>
  </div>

  <div class="col-12 text-center">
  <p><a href="https://mail.google.com/mail/u/0" class="col-sm-12 text-white">Contact@mohdjanisar.com</a></p>
  </div>
